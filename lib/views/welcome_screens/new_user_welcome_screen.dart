...
class NewUserWelcomeScreen extends StatefulWidget {
  final Function() notifyParent;
  @override
  NewUserWelcomeScreen({this.notifyParent});
  @override
  _NewUserWelcomeScreenState createState() => _NewUserWelcomeScreenState();
}

class _NewUserWelcomeScreenState extends State<NewUserWelcomeScreen> {
